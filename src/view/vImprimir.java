 ...
 */
public class vImprimir extends javax.swing.JFrame {

    /**
     * Creates new form vImprimir
     */
    public vImprimir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rascunho para a tela de impressão");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try {
            //criação de objeto jasperReport, pegando o arquivo .jxrml no src
            //criação de relatorio vazio(sem os dados) apartir do .jxrml
            ...
            JDialog tela = new JDialog(this, "Relatorio de saida",true);
            tela.setSize(2480, 3508 );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vImprimir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
